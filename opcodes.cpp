...
static instr cp_instrs[] = {
	...
	{"IYL", {0xBD, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr jp_instrs[] = {
	...
	{"Z,*", {0xCA}, 1, 10, 10, false, 0x00, 3},
	{"NC,*", {0xD2}, 1, 10, 10, false, 0x00, 3},
	{"C,*", {0xDA}, 1, 10, 10, false, 0x00, 3},
	{"PO,*", {0xE2}, 1, 10, 10, false, 0x00, 3},
	{"(HL)", {0xE9}, 1, 4, 4, false, 0x00, 1},
	{"PE,*", {0xEA}, 1, 10, 10, false, 0x00, 3},
	{"P,*", {0xF2}, 1, 10, 10, false, 0x00, 3},
...
static instr ld_instrs[] = {
	...
	{"IXH,B", {0x60, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,B", {0x60, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXH,C", {0x61, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,C", {0x61, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXH,D", {0x62, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,D", {0x62, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXH,E", {0x63, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,E", {0x63, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXH,IXH", {0x64, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,IYH", {0x64, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXH,IXL", {0x65, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,IYL", {0x65, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"H,(IX@)", {0x66, 0xDD}, 2, 19, 19, false, 0x00, 3},
	{"H,(IY@)", {0x66, 0xFD}, 2, 19, 19, false, 0x00, 3},
	{"IXH,A", {0x67, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYH,A", {0x67, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,B", {0x68, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,B", {0x68, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,C", {0x69, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,C", {0x69, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,D", {0x6A, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,D", {0x6A, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,E", {0x6B, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,E", {0x6B, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,IXH", {0x6C, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,IYH", {0x6C, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL,IXL", {0x6D, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,IYL", {0x6D, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"L,(IX@)", {0x6E, 0xDD}, 2, 19, 19, false, 0x00, 3},
	{"L,(IY@)", {0x6E, 0xFD}, 2, 19, 19, false, 0x00, 3},
	{"IXL,A", {0x6F, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL,A", {0x6F, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"(*),IX", {0x22, 0xDD}, 2, 20, 20, false, 0x00, 4},
	{"(*),IY", {0x22, 0xFD}, 2, 20, 20, false, 0x00, 4},
	{"IXH,&", {0x26, 0xDD}, 2, 11, 11, false, 0x00, 3},
	{"IYH,&", {0x26, 0xFD}, 2, 11, 11, false, 0x00, 3},
	{"IX,(*)", {0x2A, 0xDD}, 2, 20, 20, false, 0x00, 4},
	{"IY,(*)", {0x2A, 0xFD}, 2, 20, 20, false, 0x00, 4},
	{"IXL,&", {0x2E, 0xDD}, 2, 11, 11, false, 0x00, 3},
	{"IYL,&", {0x2E, 0xFD}, 2, 11, 11, false, 0x00, 3},
	{"B,IXH", {0x44, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"B,IYH", {0x44, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"B,IXL", {0x45, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"B,IYL", {0x45, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"B,(IX@)", {0x46, 0xDD}, 2, 19, 19, false, 0x00, 3},
	{"B,(IY@)", {0x46, 0xFD}, 2, 19, 19, false, 0x00, 3},
	{"C,IXH", {0x4C, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"C,IYH", {0x4C, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"C,IXL", {0x4D, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"C,IYL", {0x4D, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"C,(IX@)", {0x4E, 0xDD}, 2, 19, 19, false, 0x00, 3},
	{"C,(IY@)", {0x4E, 0xFD}, 2, 19, 19, false, 0x00, 3},
	{"D,IXH", {0x54, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"D,IYH", {0x54, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"D,IXL", {0x55, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"D,IYL", {0x55, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"D,(IX@)", {0x56, 0xDD}, 2, 19, 19, false, 0x00, 3},
	{"D,(IY@)", {0x56, 0xFD}, 2, 19, 19, false, 0x00, 3},
	{"E,IXH", {0x5C, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"E,IYH", {0x5C, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"E,IXL", {0x5D, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"E,IYL", {0x5D, 0xFD}, 2, 8, 8, false, 0x00, 2},
	...
	{"A,IXH", {0x7C, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"A,IYH", {0x7C, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"A,IXL", {0x7D, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"A,IYL", {0x7D, 0xFD}, 2, 8, 8, false, 0x00, 2},
	...
	{"(*),HL", {0x63, 0xED}, 2, 20, 20, false, 0x00, 4},
...
static instr or_instrs[] = {
	...
	{"IYL", {0xB5, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr rl_instrs[] = {
	...
	{"C,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x11, 4},
	{"D,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x12, 4},
	{"D,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x12, 4},
	{"E,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x13, 4},
	{"E,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x13, 4},
	{"H,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x14, 4},
	{"H,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x14, 4},
	{"L,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x15, 4},
	{"L,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x15, 4},
	{"(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x16, 4},
	{"(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x16, 4},
	{"A,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x17, 4},
	{"A,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x17, 4},
...
static instr rr_instrs[] = {
	...
	{"C,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x19, 4},
	{"D,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1A, 4},
	{"D,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1A, 4},
	{"E,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1B, 4},
	{"E,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1B, 4},
	{"H,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1C, 4},
	{"H,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1C, 4},
	{"L,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1D, 4},
	{"L,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1D, 4},
	{"(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1E, 4},
	{"(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1E, 4},
	{"A,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x1F, 4},
	{"A,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x1F, 4},
...
static instr adc_instrs[] = {
	...
	{"A,IYL", {0x8D, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr add_instrs[] = {
	...
	{"A,IXH", {0x84, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"A,IYH", {0x84, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"A,IXL", {0x85, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"A,IYL", {0x85, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr and_instrs[] = {
	...
	{"IYL", {0xA5, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr dec_instrs[] = {
	...
	{"IXL", {0x2D, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL", {0x2D, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr inc_instrs[] = {
	...
	{"IYH", {0x24, 0xFD}, 2, 8, 8, false, 0x00, 2},
	{"IXL", {0x2C, 0xDD}, 2, 8, 8, false, 0x00, 2},
	{"IYL", {0x2C, 0xFD}, 2, 8, 8, false, 0x00, 2},
...
static instr res_instrs[] = {
	...
	{"C,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x81, 4},
	{"D,^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x82, 4},
	{"D,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x82, 4},
	{"E,^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x83, 4},
	{"E,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x83, 4},
	{"H,^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x84, 4},
	{"H,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x84, 4},
	{"L,^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x85, 4},
	{"L,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x85, 4},
	{"^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x86, 4},
	{"^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x86, 4},
	{"A,^,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x87, 4},
	{"A,^,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x87, 4},
...
static instr rlc_instrs[] = {
	...
	{"C,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x01, 4},
	{"D,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x02, 4},
	{"D,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x02, 4},
	{"E,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x03, 4},
	{"E,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x03, 4},
	{"H,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x04, 4},
	{"H,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x04, 4},
	{"L,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x05, 4},
	{"L,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x05, 4},
	{"(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x06, 4},
	{"(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x06, 4},
	{"A,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x07, 4},
	{"A,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x07, 4},
...
static instr rrc_instrs[] = {
	...
	{"C,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x09, 4},
	{"D,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0A, 4},
	{"D,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0A, 4},
	{"E,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0B, 4},
	{"E,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0B, 4},
	{"H,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0C, 4},
	{"H,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0C, 4},
	{"L,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0D, 4},
	{"L,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0D, 4},
	{"(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0E, 4},
	{"(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0E, 4},
	{"A,(IX@)", {0xCB, 0xDD}, 2, 23, 23, true, 0x0F, 4},
	{"A,(IY@)", {0xCB, 0xFD}, 2, 23, 23, true, 0x0F, 4},
...
static instr sbc_instrs[] = {
	...
	{"A,IYL", {0x9D, 0xFD}, 2, 8, 8, false, 0x00, 2},
