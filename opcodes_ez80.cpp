...
opcode opcode_list_ez80[] = {
		{ "LD", ld_instrs, NumElm(ld_instrs), 0, &opcode_list_ez80[1], false },
		{ "CALL", call_instrs, NumElm(call_instrs), 0, &opcode_list_ez80[2], false },
		{ "RET", ret_instrs, NumElm(ret_instrs), 0, &opcode_list_ez80[3], false },
		{ "JR", jr_instrs, NumElm(jr_instrs), 0, &opcode_list_ez80[4], false },
		{ "JP", jp_instrs, NumElm(jp_instrs), 0, &opcode_list_ez80[5], false },
		{ "ADD", add_instrs, NumElm(add_instrs), 0, &opcode_list_ez80[6], false },
		{ "INC", inc_instrs, NumElm(inc_instrs), 0, &opcode_list_ez80[7], false },
		{ "POP", pop_instrs, NumElm(pop_instrs), 0, &opcode_list_ez80[8], false },
		{ "PUSH", push_instrs, NumElm(push_instrs), 0, &opcode_list_ez80[9], false },
		{ "DEC", dec_instrs, NumElm(dec_instrs), 0, &opcode_list_ez80[10], false },
		{ "CP", cp_instrs, NumElm(cp_instrs), 0, &opcode_list_ez80[11], false },
		{ "OR", or_instrs, NumElm(or_instrs), 0, &opcode_list_ez80[12], false },
		{ "EX", ex_instrs, NumElm(ex_instrs), 0, &opcode_list_ez80[13], false },
		{ "XOR", xor_instrs, NumElm(xor_instrs), 0, &opcode_list_ez80[14], false },
		{ "EXX", exx_instrs, NumElm(exx_instrs), 0, &opcode_list_ez80[15], false },
		{ "SUB", sub_instrs, NumElm(sub_instrs), 0, &opcode_list_ez80[16], false },
		{ "AND", and_instrs, NumElm(and_instrs), 0, &opcode_list_ez80[17], false },
		{ "SET", set_instrs, NumElm(set_instrs), 0, &opcode_list_ez80[18], false },
		{ "BIT", bit_instrs, NumElm(bit_instrs), 0, &opcode_list_ez80[19], false },
		{ "DJNZ", djnz_instrs, NumElm(djnz_instrs), 0, &opcode_list_ez80[20], false },
		{ "RRA", rra_instrs, NumElm(rra_instrs), 0, &opcode_list_ez80[21], false },
		{ "RR", rr_instrs, NumElm(rr_instrs), 0, &opcode_list_ez80[22], false },
		{ "SRA", sra_instrs, NumElm(sra_instrs), 0, &opcode_list_ez80[23], false },
		{ "RES", res_instrs, NumElm(res_instrs), 0, &opcode_list_ez80[24], false },
		{ "LDIR", ldir_instrs, NumElm(ldir_instrs), 0, &opcode_list_ez80[25], false },
		{ "RLA", rla_instrs, NumElm(rla_instrs), 0, &opcode_list_ez80[26], false },
		{ "OUT", out_instrs, NumElm(out_instrs), 0, &opcode_list_ez80[27], false },
		{ "SBC", sbc_instrs, NumElm(sbc_instrs), 0, &opcode_list_ez80[28], false },
		{ "CPL", cpl_instrs, NumElm(cpl_instrs), 0, &opcode_list_ez80[29], false },
		{ "RL", rl_instrs, NumElm(rl_instrs), 0, &opcode_list_ez80[30], false },
		{ "NEG", neg_instrs, NumElm(neg_instrs), 0, &opcode_list_ez80[31], false },
		{ "RLC", rlc_instrs, NumElm(rlc_instrs), 0, &opcode_list_ez80[32], false },
		{ "SRL", srl_instrs, NumElm(srl_instrs), 0, &opcode_list_ez80[33], false },
		{ "RST", rst_instrs, NumElm(rst_instrs), 0, &opcode_list_ez80[34], false },
		{ "IN", in_instrs, NumElm(in_instrs), 0, &opcode_list_ez80[35], false },
		{ "LDDR", lddr_instrs, NumElm(lddr_instrs), 0, &opcode_list_ez80[36], false },
		{ "EI", ei_instrs, NumElm(ei_instrs), 0, &opcode_list_ez80[37], false },
		{ "IM", im_instrs, NumElm(im_instrs), 0, &opcode_list_ez80[38], false },
		{ "ADC", adc_instrs, NumElm(adc_instrs), 0, &opcode_list_ez80[39], false },
		{ "DAA", daa_instrs, NumElm(daa_instrs), 0, &opcode_list_ez80[40], false },
		{ "DI", di_instrs, NumElm(di_instrs), 0, &opcode_list_ez80[41], false },
		{ "NOP", nop_instrs, NumElm(nop_instrs), 0, &opcode_list_ez80[42], false },
		{ "RLCA", rlca_instrs, NumElm(rlca_instrs), 0, &opcode_list_ez80[43], false },
		{ "SLA", sla_instrs, NumElm(sla_instrs), 0, &opcode_list_ez80[44], false },
		{ "LDI", ldi_instrs, NumElm(ldi_instrs), 0, &opcode_list_ez80[45], false },
		{ "CCF", ccf_instrs, NumElm(ccf_instrs), 0, &opcode_list_ez80[46], false },
		{ "SCF", scf_instrs, NumElm(scf_instrs), 0, &opcode_list_ez80[47], false },
		{ "RRC", rrc_instrs, NumElm(rrc_instrs), 0, &opcode_list_ez80[48], false },
		{ "HALT", halt_instrs, NumElm(halt_instrs), 0, &opcode_list_ez80[49], false },
		{ "RLD", rld_instrs, NumElm(rld_instrs), 0, &opcode_list_ez80[50], false },
		{ "TST", tst_instrs, NumElm(tst_instrs), 0, &opcode_list_ez80[51], false },
		{ "CPD", cpd_instrs, NumElm(cpd_instrs), 0, &opcode_list_ez80[52], false },
		{ "CPDR", cpdr_instrs, NumElm(cpdr_instrs), 0, &opcode_list_ez80[53], false },
		{ "CPI", cpi_instrs, NumElm(cpi_instrs), 0, &opcode_list_ez80[54], false },
		{ "CPIR", cpir_instrs, NumElm(cpir_instrs), 0, &opcode_list_ez80[55], false },
		{ "IND", ind_instrs, NumElm(ind_instrs), 0, &opcode_list_ez80[56], false },
		{ "INDR", indr_instrs, NumElm(indr_instrs), 0, &opcode_list_ez80[57], false },
		{ "INI", ini_instrs, NumElm(ini_instrs), 0, &opcode_list_ez80[58], false },
		{ "INIR", inir_instrs, NumElm(inir_instrs), 0, &opcode_list_ez80[59], false },
		{ "LDD", ldd_instrs, NumElm(ldd_instrs), 0, &opcode_list_ez80[60], false },
		{ "OTDR", otdr_instrs, NumElm(otdr_instrs), 0, &opcode_list_ez80[61], false },
		{ "OTIR", otir_instrs, NumElm(otir_instrs), 0, &opcode_list_ez80[62], false },
		{ "OUTD", outd_instrs, NumElm(outd_instrs), 0, &opcode_list_ez80[63], false },
		{ "OUTI", outi_instrs, NumElm(outi_instrs), 0, &opcode_list_ez80[64], false },
		{ "RETI", reti_instrs, NumElm(reti_instrs), 0, &opcode_list_ez80[65], false },
		{ "RETN", retn_instrs, NumElm(retn_instrs), 0, &opcode_list_ez80[66], false },
		{ "RRCA", rrca_instrs, NumElm(rrca_instrs), 0, &opcode_list_ez80[67], false },
		{ "RRD", rrd_instrs, NumElm(rrd_instrs), 0, &opcode_list_ez80[68], false },
		{ "LEA", lea_instrs, NumElm(lea_instrs), 0, &opcode_list_ez80[69], false },
		{ "PEA", pea_instrs, NumElm(pea_instrs), 0, &opcode_list_ez80[70], false },
		{ "MLT", mlt_instrs, NumElm(mlt_instrs), 0, &opcode_list_ez80[71], false },
		{ "IND2", ind2_instrs, NumElm(ind2_instrs), 0, &opcode_list_ez80[72], false },
		{ "INDM", indm_instrs, NumElm(indm_instrs), 0, &opcode_list_ez80[73], false },
		{ "INI2", ini2_instrs, NumElm(ini2_instrs), 0, &opcode_list_ez80[74], false },
		{ "INIM", inim_instrs, NumElm(inim_instrs), 0, &opcode_list_ez80[75], false },
		{ "OTDM", otdm_instrs, NumElm(otdm_instrs), 0, &opcode_list_ez80[76], false },
		{ "OTIM", otim_instrs, NumElm(otim_instrs), 0, &opcode_list_ez80[77], false },
		{ "OUT0", out0_instrs, NumElm(out0_instrs), 0, &opcode_list_ez80[78], false },
		{ "IN0", in0_instrs, NumElm(in0_instrs), 0, &opcode_list_ez80[79], false },
		{ "SLP", slp_instrs, NumElm(slp_instrs), 0, &opcode_list_ez80[80], false },
		{ "IND2R", ind2r_instrs, NumElm(ind2r_instrs), 0, &opcode_list_ez80[81], false },
		{ "INDMR", indmr_instrs, NumElm(indmr_instrs), 0, &opcode_list_ez80[82], false },
		{ "INDRX", indrx_instrs, NumElm(indrx_instrs), 0, &opcode_list_ez80[83], false },
		{ "INI2R", ini2r_instrs, NumElm(ini2r_instrs), 0, &opcode_list_ez80[84], false },
		{ "INIMR", inimr_instrs, NumElm(inimr_instrs), 0, &opcode_list_ez80[85], false },
		{ "INIRX", inirx_instrs, NumElm(inirx_instrs), 0, &opcode_list_ez80[86], false },
		{ "OTD2R", otd2r_instrs, NumElm(otd2r_instrs), 0, &opcode_list_ez80[87], false },
		{ "OTDMR", otdmr_instrs, NumElm(otdmr_instrs), 0, &opcode_list_ez80[88], false },
		{ "OTDRX", otdrx_instrs, NumElm(otdrx_instrs), 0, &opcode_list_ez80[89], false },
		{ "OTI2R", oti2r_instrs, NumElm(oti2r_instrs), 0, &opcode_list_ez80[90], false },
		{ "OTIMR", otimr_instrs, NumElm(otimr_instrs), 0, &opcode_list_ez80[91], false },
		{ "OTIRX", otirx_instrs, NumElm(otirx_instrs), 0, &opcode_list_ez80[92], false },
		{ "OUTD2", outd2_instrs, NumElm(outd2_instrs), 0, &opcode_list_ez80[93], false },
		{ "OUTI2", outi2_instrs, NumElm(outi2_instrs), 0, &opcode_list_ez80[94], false },
		{ "RSMIX", rsmix_instrs, NumElm(rsmix_instrs), 0, &opcode_list_ez80[95], false },
		{ "STMIX", stmix_instrs, NumElm(stmix_instrs), 0, &opcode_list_ez80[96], false },
